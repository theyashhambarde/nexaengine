...
COPY --from=builder /home/nexa/public ./public
COPY --from=builder /home/nexa/.next/static ./public/_next/static
COPY --from=builder /home/nexa/.next/standalone ./
COPY --from=builder /home/nexa/data ./data
COPY drizzle ./drizzle

RUN mkdir /home/nexa/uploads
