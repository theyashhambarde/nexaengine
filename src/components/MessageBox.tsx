          ...
          {isLast &&
            ...
            !section.message.responseBlocks.some(
              ...
              <motion.div
                ...
                className="flex items-center gap-3 p-3 rounded-xl bg-light-secondary/50 dark:bg-dark-secondary/50 border border-light-200 dark:border-dark-200 backdrop-blur-sm w-fit"
              >
                <div className="relative flex items-center justify-center">
                  <motion.div
                    ...
                    className="absolute w-6 h-6 rounded-full bg-sky-500/20 dark:bg-sky-500/10"
                  />
                  <BrainCircuit size={18} className="text-sky-500" />
                </div>
                <span className="text-sm font-medium text-black/70 dark:text-white/70 animate-pulse">
                  Thinking...
                </span>
              </motion.div>
            )}
                ...
                {isLast && loading ? (
                  <div className="relative flex items-center justify-center">
                    <motion.div
                      ...
                      className="absolute w-5 h-5 rounded-full bg-sky-500/20 dark:bg-sky-500/10"
                    />
                    <Disc3 size={20} className="text-sky-500 animate-spin" />
                  </div>
                ) : (
                  <Disc3 size={20} className="text-black dark:text-white" />
                )}
                <h3 className="text-black dark:text-white font-medium text-xl">
                  Answer
                </h3>
