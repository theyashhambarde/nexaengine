...
const OptimizationModes = [
  {
    key: 'speed',
    title: 'Flash',
    description: 'Lightning-fast answers for when speed is everything.',
    icon: <Zap size={16} className="text-[#FF9800]" />,
  },
  {
    key: 'balanced',
    title: 'Smart',
    description: 'Intelligent processing that balances detail and velocity.',
    icon: <Sliders size={16} className="text-[#4CAF50]" />,
  },
  {
    key: 'quality',
    title: 'Deep',
    description: 'Exhaustive analysis and multi-step research for complex tasks.',
    icon: (
      <Star
        size={16}
